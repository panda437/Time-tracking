          ...
          <div className="px-8 py-8">
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <button
                ...
                className="w-full py-4 px-6 rounded-2xl font-semibold text-lg transition-smooth shadow-lg bg-white border-2 border-gray-200 text-gray-700 hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] hover:bg-gray-50 mb-4"
              >
