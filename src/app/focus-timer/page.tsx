        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <Link href="/" className="flex items-center space-x-3">
              ...
              <span className="text-xl font-bold text-[#222222]">Roozi</span>
            </Link>
            <Link 
              href="/api/auth/signin/google"
              className="px-4 py-2 bg-gradient-to-r from-[#FF385C] to-[#E31C5F] text-white rounded-xl hover:shadow-lg transition-all text-sm font-medium"
            >
              Sign In
            </Link>
          </div>
        ...
        <div className="text-center mt-12">
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 max-w-md mx-auto">
            ...
            <p className="text-gray-600 mb-6">
              Sign up to save your focus sessions and track your productivity over time.
            </p>
            <Link 
              href="/api/auth/signin/google"
              className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-[#FF385C] to-[#E31C5F] text-white rounded-xl hover:shadow-lg transition-all font-medium"
            >
              Get Started Free
            </Link>
          </div>
